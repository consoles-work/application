...
### AI Ассистент
- Чат-панель с **ChatGPT** (OpenAI) и **Claude** (Anthropic)
- **Выделите текст** в терминале → кнопка Bot в баре вкладок → отправить в AI с контекстом
...
- Настройка провайдера, API-ключа и модели в Settings → Агенты
